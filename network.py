...
class Net(object):
    ...
    def build_network(self):
        ...
        self.labels, self.anchor_obj = self._anchor_labels_process(self.gt_boxes, self.all_anchors, self.anchor_batch,\
                                                  cfg.overlaps_max, cfg.overlaps_min, self.image_width, self.image_height,self.flag,self.atss) #anchor process and generate anchor lable[0,-1,1]
